          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-xs sm:text-responsive-base lg:text-xs text-gray-400 leading-relaxed">
                {experience.desc} {experience.company==="Atnatic" ? <a href="https://www.atnatic.com" target="_blank" rel="noopener noreferrer" className="text-decoration-underline text-purple-500">LIVE</a>:""}
              </p>
              <div className="mt-2">
